...
const LeftSideBar = () => {
  ...
  return !isLoaded ? (
    <div className="h-screen left-0 top-0 sticky overflow-auto px-10 py-6 flex flex-col gap-6 max-md:hidden 2xl:w-[350px] pr-20 custom-scrollbar animate-pulse">
      <div className="h-8 bg-gray-200 rounded mb-5 w-3/4"></div>
      <div className="flex flex-col gap-2 items-center text-light-1">
        <div className="w-12 h-12 bg-gray-200 rounded-full"></div>
        <div className="h-4 bg-gray-200 rounded w-1/2 mt-2"></div>
      </div>
      <div className="flex text-light-1 justify-between mt-4">
        {[...Array(3)].map((_, index) => (
